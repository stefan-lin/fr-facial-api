...
=begin
VipsController CLASS
This class helps users to create, show, update, and delete the VIPs
VIP is the comparatee that will be used to be compared with user's photo
=end
...
class VipsController < ApplicationController
  ...
  # POST /vips.json
  # Method create
  # This method will take users' input and create a new Vip object. Then, it
  # will save the Vip information into database.
  def create
  ...
  # Method update
  # update existed vip information in database
  def update
    respond_to do |format|
